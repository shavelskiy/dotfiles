...
return {
  { 'DapBreakpoint', { fg = colors.base08, bg = colors.base04 } },
  { 'DapLogPoint', { fg = colors.base0D, bg = colors.base04 } },
  { 'DapStopped', { fg = colors.base0B, bg = colors.base04 } },
  ...
  { 'DapUIFloatBorder', { fg = colors.base04 } },
